...
const DATA = [
    ...
    { type_id: 1, external_id: 950160802, name: 'BITCOIN', symbol: 'BTC-USDT', is_active: true },
    { type_id: 1, external_id: 950190134, name: 'SOLANA', symbol: 'SOL-USDT', is_active: true },
    { type_id: 1, external_id: 950160801, name: 'LITECOIN', symbol: 'LTC-USDT', is_active: true },
    { type_id: 1, external_id: 950160804, name: 'ETHEREUM', symbol: 'ETH-USDT', is_active: true },
]
...
export class PopulateAssets1730604737786 implements MigrationInterface {
